...
　　　　　　　　<a href="https://www.codecogs.com/eqnedit.php?latex=\delta&space;_{11}=\sum_{i=1}^{m}\sum_{i=1}^{n}h_{m,n}\delta&space;_{i&plus;m,j&plus;n}\cdot&space;f'(net_{i_{11}})" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\delta&space;_{11}=\sum_{i=1}^{m}\sum_{i=1}^{n}h_{m,n}\delta&space;_{i&plus;m,j&plus;n}\cdot&space;f'(net_{i_{11}})" title="\delta _{11}=\sum_{i=1}^{m}\sum_{i=1}^{n}h_{m,n}\delta _{i+m,j+n}\cdot f'(net_{i_{11}})" /></a>

　　　　　　　　<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{\partial&space;E}{\partial&space;h_{i,j}}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta&space;_{m,n}out_{o_{i&plus;m,j&plus;n}}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{\partial&space;E}{\partial&space;h_{i,j}}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta&space;_{m,n}out_{o_{i&plus;m,j&plus;n}}" title="\frac{\partial E}{\partial h_{i,j}}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta _{m,n}out_{o_{i+m,j+n}}" /></a>

　　　　　　　　<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{\partial&space;E}{\partial&space;b}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta&space;_{i,j}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{\partial&space;E}{\partial&space;b}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta&space;_{i,j}" title="\frac{\partial E}{\partial b}=\sum_{i=1}^{m}\sum_{i=1}^{n}\delta _{i,j}" /></a>
